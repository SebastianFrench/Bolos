...
public class Bolos {
    ...
    public static int lance1 = 0, lance2 = 0, lance3=0;
    ...
    public static void logicaPuntuacion() {
        ...
        int chuzat=0;
        int spare=0;
        for (int turno = 0; turno < 10; turno++) {  //Ciclo para los 10 turnos

            lance1 = 0;                //Inicializo cada lance en 0

            lance2 = 0;                //Inicializo cada lance en 0

            System.out.println("Este es su: " + (turno + 1) + " Tiro"); // Imprime el turno en el que va
            ...
            if (lance1 == 10) {     //Condición cuando el primer lance es 10(Strike)
                ...
                do {
                    ...
                    if (total < 10) {                        //esta condicion es para evaluar si es posible el valor total es decir que sea menor que 10, si es 10 es un Spare
                        ...
                        if (chuza == 20) {
                            chuza = chuza + lance1 + chuza - (10 - total);
                            puntuacion += chuza;
                            chuza = 0;
                        }
                        if (chuza >= 30) {
                            int turn = turno - 2;
                            chuza = turn * chuza + (chuza - 10) + lance1 + chuza - 20 + total;;
                            puntuacion += chuza;
                            chuza = 0;
                        }

                    }
                    if(total==10){              //Spare, SEBASTIÁN LEON
